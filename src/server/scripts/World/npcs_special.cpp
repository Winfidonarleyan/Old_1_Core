...
public:
	...
	{
		player->PlayerTalkClass->ClearMenus();
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_VENDOR, "Open Vendor 1", GOSSIP_SENDER_MAIN, 1);
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_VENDOR, "Open Vendor 2", GOSSIP_SENDER_MAIN, 2);
	...
	bool OnGossipSelect(Player *player, Creature *creature, uint32 sender, uint32 action)
	{
		...
		{
		case 1:
			player->GetSession()->SendListInventory(200133);
			break;
		case 2:
			player->GetSession()->SendListInventory(200133);
			break;
