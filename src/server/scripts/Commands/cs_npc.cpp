...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand npcSetCommandTable[] =
        {
            ...
            { "health",         SEC_GAMEMASTER,     false, &HandleNpcSetHealthCommand,         "", NULL },
    ...
    static bool HandleNpcInfoCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        handler->PSendSysMessage(LANG_NPCINFO_CHAR,  target->GetDBTableGUIDLow(), target->GetGUIDLow(), Entry, displayid, nativeid);
    ...
    */
    ...
    static bool HandleNpcSetHealthCommand(ChatHandler* handler, const char* args)
    {
        if (!*args)
            return false;

        int32 hp = (int32) atoi((char*)args);
