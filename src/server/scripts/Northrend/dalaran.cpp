...
#define GOSSIP_TEXT_SEE_FALL_OF_THE_LICH_KING	"Смотреть падение Короля лича."
...
public: 
    ...
    {
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SEE_FALL_OF_THE_LICH_KING, GOSSIP_SENDER_MAIN, EPIC_FAIL);
