...
void AddSC_boss_sindragosa()
{
    ...
    new spell_trigger_spell_from_caster("spell_sindragosa_ice_tomb_dummy", SPELL_ICE_TOMB_DUMMY);
    new spell_trigger_spell_from_caster("spell_sindragosa_ice_tomb", SPELL_FROST_BEACON);
