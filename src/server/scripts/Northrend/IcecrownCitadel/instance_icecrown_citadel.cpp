...
class instance_icecrown_citadel : public InstanceMapScript
{
    public:
        ...
        struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature* creature)
            {
                ...
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_PROFESSOR_PUTRICIDE:
                        ...
                        break;
                    case NPC_BP_CONTROLLER:
                        BPControllerGUID = creature->GetGUID();
                        break;
            ...
            uint32 GetData(uint32 type)
            {
                switch (type)
                {
                    ...
                    case DATA_EVENT_BEFORE_SINDRAGOSA:
                        return EventBeforeSindragosaState;
            ...
            uint64 GetData64(uint32 type)
            {
                switch (type)
                {
                    ...
                    case DATA_BP_CONTROLLER_GUID:
                        return BPControllerGUID;
            ...
            void SetData(uint32 type, uint32 data)
            {
                switch (type)
                {
                    ...
                    case DATA_ORB_WHISPERER_ACHIEVEMENT:
                        ...
                        break;
                    case DATA_EVENT_BEFORE_SINDRAGOSA:
                        EventBeforeSindragosaState = data;
                        break;
                    case DATA_SINDRAGOSA_FROSTWYRMS:
            ...
            bool CheckRequiredBosses(uint32 bossId, Player* player) const
            {
            ...
            bool CheckLowerSpire(uint32 bossId) const
            {
                switch (bossId)
                {
                    ...
                    case DATA_FESTERGUT:
                        ...
                        // no break
                    case DATA_DEATHBRINGER_SAURFANG:
                        // turn off check if GunShip done
                        if (GetBossState(DATA_LADY_DEATHWHISPER) != DONE)
                            return false;
                        // no break
        ...
        protected:
            ...
            uint64 SindragosaEntranceDoorGUID;
            ...
            uint32 EventBeforeSindragosaState;
