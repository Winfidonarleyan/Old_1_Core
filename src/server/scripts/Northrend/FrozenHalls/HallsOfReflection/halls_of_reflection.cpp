...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        if (creature->isQuestGiver())
            ...
            player->ADD_GOSSIP_ITEM(0, "Вы можете забрать меч?", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Бежим отсюда!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_OUTRO_3:
                            ...
                            if(instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                            {
                                ...
                                me->SummonGameObject(GO_STAIRS_SKYBREAKER, 5246.45f, 1627.75f, 784.302f, 5.46113f, 0, 0, 0.199211f, -0.979957f, 1*DAY);
                            ...
                            } else
                            {
                                ...
                                me->SummonGameObject(GO_STAIRS_ORGRIM_HAMMER, 5246.15f, 1624.48f, 784.302f, 5.88208f, 0, 0, 0.199211f, -0.979957f, 1*DAY);
