...
class Unit : public WorldObject
{
    public:
		...
		uint32 GetMeleeDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_MELEE, 2.0f, sWorld->getRate(RATE_CAP_RESILIENCE_MELEE), damage); }
		uint32 GetRangedDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_RANGED, 2.0f, sWorld->getRate(RATE_CAP_RESILIENCE_RANGED), damage); }
		uint32 GetSpellDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.0f, sWorld->getRate(RATE_CAP_RESILIENCE_SPELL), damage); }
