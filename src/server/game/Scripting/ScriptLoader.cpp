...
void AddCustomScripts()
{
    ...
    AddSC_Unell_VIP_System();
	AddSC_Unell_Announcer_System();
	AddSC_Unell_Login_System();
	AddSC_Unell_Chat_System();
	AddSC_Unell_Custom();
	AddSC_Unell_Custom_NPC();
	AddSC_Unell_Custom_Event();
	AddSC_Unell_Area_System();
	AddSC_Unell_PvP_System();
	AddSC_Unell_Referer_System();
	AddSC_Unell_Guild_System();
	AddSC_Unell_Top_System();
#endif
}
