...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_CHAT_CHANNEL_TIME_REQ] = ConfigMgr::GetIntDefault("ChatLevelTimeReq.Channel", 1800);
    m_int_configs[CONFIG_CHAT_WHISPER_LEVEL_REQ] = ConfigMgr::GetIntDefault("ChatLevelReq.Whisper", 1);
    m_int_configs[CONFIG_CHAT_WHISPER_TIME_REQ] = ConfigMgr::GetIntDefault("ChatTimeReq.Whisper", 1800);
    m_int_configs[CONFIG_CHAT_SAY_LEVEL_REQ] = ConfigMgr::GetIntDefault("ChatLevelReq.Say", 1);
    m_int_configs[CONFIG_CHAT_SAY_TIME_REQ] = ConfigMgr::GetIntDefault("ChatTimeReq.Say", 1800);
	...
	// ArenaEndConfig
	m_int_configs[CONFIG_END_ARENA_ADD_WIN] = ConfigMgr::GetIntDefault("PlayerAddHonorForWin", 0);
	m_int_configs[CONFIG_END_ARENA_ADD_LOST] = ConfigMgr::GetIntDefault("PlayerAddHonorForLost", 0);
	m_int_configs[CONFIG_END_ARENA_ADD_ITEM] = ConfigMgr::GetIntDefault("PlayerAddItemForWin", 0);
	m_int_configs[CONFIG_END_ARENA_ADD_ITEM_COUNT] = ConfigMgr::GetIntDefault("PlayerAddItemForWinCount", 1);
    ...
    m_int_configs[CONFIG_TRIUMPH_FOR_FROST_COUNT] = ConfigMgr::GetIntDefault("TriumphForFrostCount", 5);
    ...
    m_bool_configs[CONFIG_ARENA_SPECTATORS_ONLY_FRIEND]              = ConfigMgr::GetBoolDefault("Arena.Spectators.Only.Friend", true);
	...
	m_bool_configs[CONFIG_UNELL_GM_HELLO]                            = ConfigMgr::GetBoolDefault("Unell.GM.Hello", false);
	m_bool_configs[CONFIG_UNELL_PLAYER_HELLO]                        = ConfigMgr::GetBoolDefault("Unell.Player.Hello", false);
    m_bool_configs[CONFIG_UNELL_GM_ENTER]                            = ConfigMgr::GetBoolDefault("Unell.GM.Enter", false);
	m_bool_configs[CONFIG_UNELL_BOSS_ANNOUNCER]                      = ConfigMgr::GetBoolDefault("Unell.Boss.Announcer", false);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_1]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.1", true);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_2]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.2", true);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_3]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.3", true);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_4]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.4", true);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_5]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.5", true);
	m_bool_configs[CONFIG_UNELL_GM_ENTER_LEVEL_6]                    = ConfigMgr::GetBoolDefault("Unell.GM.Enter.Level.6", true);
	m_float_configs[CONFIG_MAX_DODGE]                                = ConfigMgr::GetIntDefault("Unell.Max.Dodge", 100.0f);
	m_float_configs[CONFIG_MAX_PARRY]                                = ConfigMgr::GetIntDefault("Unell.Max.Parry", 100.0f);
	m_float_configs[CONFIG_MAX_CRIT]                                 = ConfigMgr::GetIntDefault("Unell.Max.Crit", 100.0f);
	m_float_configs[CONFIG_MAX_BLOCK]                                = ConfigMgr::GetIntDefault("Unell.Max.Block", 100.0f);
	m_int_configs[CONFIG_GM_CHAT_COLOR]                              = ConfigMgr::GetIntDefault("Unell.GM.Chat.Color", 1);	
	
	m_int_configs[CONFIG_UNELL_PLAYED_INTERVAL]                      = ConfigMgr::GetIntDefault("Unell.PlayedTimeReward.Interval", 0);
	m_int_configs[CONFIG_UNELL_PLAYED_MONEY]                         = ConfigMgr::GetIntDefault("Unell.PlayedTimeReward.Money", 0);
	m_int_configs[CONFIG_UNELL_PLAYED_HONOR]                         = ConfigMgr::GetIntDefault("Unell.PlayedTimeReward.Honor", 0);
	m_int_configs[CONFIG_UNELL_PLAYED_TOKEN]                         = ConfigMgr::GetIntDefault("Unell.PlayedTimeReward.Token", 0);
	m_int_configs[CONFIG_UNELL_PLAYED_TOKENID]                       = ConfigMgr::GetIntDefault("Unell.PlayedTimeReward.TokenID", 0);
    ...
    {
        m_dataPath = dataPath;
        sLog->outString("Используется дириктория даты %s", m_dataPath.c_str());
    }
	
	///- Read the "Datadbc" directory from the config file
    std::string datadbcPath = ConfigMgr::GetStringDefault("DatadbcDir", "./");
    if (datadbcPath.at(datadbcPath.length()-1) != '/' && datadbcPath.at(datadbcPath.length()-1) != '\\')
        datadbcPath.push_back('/');

    if (reload)
    {
        if (datadbcPath != m_datadbcPath)
            sLog->outError("DatadbcDir option can't be changed at worldserver.conf reload, using current value (%s).", m_datadbcPath.c_str());
    }
    else
    {
        m_datadbcPath = datadbcPath;
        sLog->outString("Используется дириктория DBC %s", m_datadbcPath.c_str());
    }
    ...
    sLog->outString("МИР: VMap включена поддержка. LineOfSight:%i, getHeight:%i, indoorCheck:%i PetLOS:%i", enableLOS, enableHeight, enableIndoor, enablePetLOS);
    sLog->outString("МИР: Расположение VMap: %svmaps", m_dataPath.c_str());
    ...
    if (m_bool_configs[CONFIG_START_ALL_SPELLS])
        sLog->outString("МИР: ВНИМАНИЕ: PlayerStart.AllSpells enabled - may not function as intended!");
	...
	rate_values[RATE_CAP_RESILIENCE_MELEE] = ConfigMgr::GetFloatDefault("CapResilience.CritMelee", 75.0f);
    rate_values[RATE_CAP_RESILIENCE_RANGED] = ConfigMgr::GetFloatDefault("CapResilience.CritRanged", 75.0f);
    rate_values[RATE_CAP_RESILIENCE_SPELL] = ConfigMgr::GetFloatDefault("CapResilience.CritSpell", 75.0f);
    
    rate_values[RATE_CAP_DODGE_FROM_AGILITY] = ConfigMgr::GetFloatDefault("CapDodge.FromAgility", 60.0f);
    rate_values[RATE_CAP_MANA_REGEN] = ConfigMgr::GetFloatDefault("CapManaRegen", 50.0f);    
	if (rate_values[RATE_CAP_MANA_REGEN] < 0.0f)
    {
        sLog->outError("RATE_CAP_MANA_REGEN (%f) must be > 0. and damage 100 persent's with blizzlike", rate_values[RATE_CAP_MANA_REGEN]);
        rate_values[RATE_CAP_MANA_REGEN] = 50.0f;
    }
	
    rate_values[RATE_REDUCTION_MELEE_DAMAGE] = ConfigMgr::GetFloatDefault("Reduction.Melee.Damage", 90.0f);
    if (rate_values[RATE_REDUCTION_MELEE_DAMAGE] < 0.0f)
    {
        sLog->outError("RATE_REDUCTION_MELEE_DAMAGE (%f) must be > 0. and damage 100 persent's with blizzlike",rate_values[RATE_REDUCTION_MELEE_DAMAGE]);
        rate_values[RATE_REDUCTION_MELEE_DAMAGE] = 100.0f;
    }
    ...
    // Transmogrification
    m_int_configs[TRANSMOGRIFICATION_REQUIRED_MONEY] = ConfigMgr::GetIntDefault("TransmogrificationRequiredMoney", 1000);
    ...
    m_bool_configs[CONFIG_GM_CHAT_BLUE]  = ConfigMgr::GetBoolDefault("GM.Chat.Blue", true);
    ...
    m_bool_configs[CONFIG_BOSS_KILL_HISTORY_REWARD_ENABLE] = ConfigMgr::GetBoolDefault("Boss.Kill.History.Reward.Enable", false);
    ...
    m_bool_configs[CONFIG_MULTIBOXING_KICK_ENABLE] = ConfigMgr::GetBoolDefault("Multiboxing.Kick.Enable", false);
    m_bool_configs[CONFIG_MULTIBOXING_KICK_ONLY_ON_BG_OR_ARENA] = ConfigMgr::GetBoolDefault("Multiboxing.Kick.Only.On.BG.Or.Arena", true);
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outString();
    sLog->outString("Загрузка Trinity strings...");
	...
	LoadDBCStores(m_datadbcPath);
    DetectDBCLang();

    sLog->outString("Загрузка заклинаний...");
    sSpellMgr->LoadDbcDataCorrections();

    sLog->outString("Загрузка информации о заклинаниях...");
    sSpellMgr->LoadSpellInfoStore();

    sLog->outString("Загрузка SkillLineAbilityMultiMap Data...");
    sSpellMgr->LoadSkillLineAbilityMap();

    sLog->outString("Загрузка кастомных заклинаний...");
    sSpellMgr->LoadSpellCustomAttr();

    sLog->outString("Загрузка моделей объектов...");
    LoadGameObjectModelList();

    sLog->outString("Загрузка названий скриптов...");
    sObjectMgr->LoadScriptNames();

    sLog->outString("Загрузка конфигурации подземелий...");
    sObjectMgr->LoadInstanceTemplate();

    // Must be called before `creature_respawn`/`gameobject_respawn` tables
    sLog->outString("Загрузка подземелий...");
    sInstanceSaveMgr->LoadInstances();

    sLog->outString("Загрузка локализации...");
    ...
    sLog->outString(">> Локализация загружена за %u мс", GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();

    sLog->outString("Загрузка Текстовых страниц...");
    sObjectMgr->LoadPageTexts();

    sLog->outString("Загрузка конфигурации объектов...");         // must be after LoadPageTexts
    sObjectMgr->LoadGameObjectTemplate();

    sLog->outString("Загрузка рангов заклинаний...");
    sSpellMgr->LoadSpellRanks();

    sLog->outString("Загрузка Spell Required Data...");
    sSpellMgr->LoadSpellRequired();

    sLog->outString("Загрузка групп заклинаний...");
    sSpellMgr->LoadSpellGroups();

    sLog->outString("Загрузка Spell Learn Skills...");
    sSpellMgr->LoadSpellLearnSkills();                           // must be after LoadSpellRanks

    sLog->outString("Загрузка Spell Learn Spells...");
    sSpellMgr->LoadSpellLearnSpells();

    sLog->outString("Загрузка Spell Proc Event conditions...");
    sSpellMgr->LoadSpellProcEvents();

    sLog->outString("Загрузка Spell Proc conditions and data...");
    sSpellMgr->LoadSpellProcs();

    sLog->outString("Загрузка Spell Bonus Data...");
    sSpellMgr->LoadSpellBonusess();

    sLog->outString("Загрузка Aggro Spells Definitions...");
    sSpellMgr->LoadSpellThreats();

    sLog->outString("Загрузка Spell Group Stack Rules...");
    sSpellMgr->LoadSpellGroupStackRules();

    sLog->outString("Загрузка NPC Texts...");
    sObjectMgr->LoadGossipText();

    sLog->outString("Загрузка Enchant Spells Proc datas...");
    sSpellMgr->LoadSpellEnchantProcData();

    sLog->outString("Загрузка Item Random Enchantments Table...");
    LoadRandomEnchantmentsTable();

    sLog->outString("Загрузка Disables");
    DisableMgr::LoadDisables();                                 // must be before loading quests and items

    sLog->outString("Загрузка предметов...");                         // must be after LoadRandomEnchantmentsTable and LoadPageTexts
    sObjectMgr->LoadItemTemplates();

    sLog->outString("Загрузка названий сетов...");                // must be after LoadItemPrototypes
    sObjectMgr->LoadItemSetNames();

    sLog->outString("Загрузка Creature Model Based Info Data...");
    sObjectMgr->LoadCreatureModelInfo();

    sLog->outString("Загрузка Equipment templates...");
    sObjectMgr->LoadEquipmentTemplates();

    sLog->outString("Загрузка фейковых итемов...");
    sObjectMgr->LoadFakeItems();

    sLog->outString("Загрузка конфигурации НПЦ...");
    sObjectMgr->LoadCreatureTemplates();

    sLog->outString("Загрузка Creature template addons...");
    sObjectMgr->LoadCreatureTemplateAddons();

    sLog->outString("Загрузка Reputation Reward Rates...");
    sObjectMgr->LoadReputationRewardRate();

    sLog->outString("Загрузка Creature Reputation OnKill Data...");
    sObjectMgr->LoadReputationOnKill();

    sLog->outString("Загрузка Reputation Spillover Data..." );
    sObjectMgr->LoadReputationSpilloverTemplate();

    sLog->outString("Загрузка Points Of Interest Data...");
    sObjectMgr->LoadPointsOfInterest();

    sLog->outString("Загрузка Creature Base Stats...");
    sObjectMgr->LoadCreatureClassLevelStats();

    sLog->outString("Загрузка Creature Data...");
    sObjectMgr->LoadCreatures();

    sLog->outString("Загрузка pet levelup spells...");
    sSpellMgr->LoadPetLevelupSpellMap();

    sLog->outString("Загрузка pet default spells additional to levelup spells...");
    sSpellMgr->LoadPetDefaultSpells();

    sLog->outString("Загрузка Creature Addon Data...");
    sObjectMgr->LoadCreatureAddons();                            // must be after LoadCreatureTemplates() and LoadCreatures()

    sLog->outString("Загрузка Creature Respawn Data...");         // must be after PackInstances()
    sObjectMgr->LoadCreatureRespawnTimes();

    sLog->outString("Загрузка Gameobject Data...");
    sObjectMgr->LoadGameobjects();

    sLog->outString("Загрузка Gameobject Respawn Data...");       // must be after PackInstances()
    sObjectMgr->LoadGameobjectRespawnTimes();

    sLog->outString("Загрузка Creature Linked Respawn...");
    sObjectMgr->LoadLinkedRespawn();                             // must be after LoadCreatures(), LoadGameObjects()

    sLog->outString("Загрузка Weather Data...");
    WeatherMgr::LoadWeatherData();

    sLog->outString("Загрузка Quests...");
    sObjectMgr->LoadQuests();                                    // must be loaded after DBCs, creature_template, item_template, gameobject tables

    sLog->outString("Checking Quest Disables");
    DisableMgr::CheckQuestDisables();                           // must be after Загрузка quests

    sLog->outString("Загрузка Quest POI");
    sObjectMgr->LoadQuestPOI();

    sLog->outString("Загрузка Quests Relations...");
    sObjectMgr->LoadQuestRelations();                            // must be after quest load

    sLog->outString("Загрузка Objects Pooling Data...");
    sPoolMgr->LoadFromDB();

    sLog->outString("Загрузка Game Event Data...");               // must be after Загрузка pools fully
    sGameEventMgr->LoadFromDB();

    sLog->outString("Загрузка UNIT_NPC_FLAG_SPELLCLICK Data..."); // must be after LoadQuests
    sObjectMgr->LoadNPCSpellClickSpells();

    sLog->outString("Загрузка Vehicle Template Accessories...");
    sObjectMgr->LoadVehicleTemplateAccessories();                // must be after LoadCreatureTemplates() and LoadNPCSpellClickSpells()

    sLog->outString("Загрузка Vehicle Accessories...");
    sObjectMgr->LoadVehicleAccessories();                       // must be after LoadCreatureTemplates() and LoadNPCSpellClickSpells()

    sLog->outString("Загрузка Dungeon boss data...");
    sObjectMgr->LoadInstanceEncounters();

    sLog->outString("Загрузка LFG rewards...");
    sLFGMgr->LoadRewards();

    sLog->outString("Загрузка SpellArea Data...");                // must be after quest load
    sSpellMgr->LoadSpellAreas();

    sLog->outString("Загрузка AreaTrigger definitions...");
    sObjectMgr->LoadAreaTriggerTeleports();

    sLog->outString("Загрузка Access Requirements...");
    sObjectMgr->LoadAccessRequirements();                        // must be after item template load

    sLog->outString("Загрузка Quest Area Triggers...");
    sObjectMgr->LoadQuestAreaTriggers();                         // must be after LoadQuests

    sLog->outString("Загрузка Tavern Area Triggers...");
    sObjectMgr->LoadTavernAreaTriggers();

    sLog->outString("Загрузка AreaTrigger script names...");
    sObjectMgr->LoadAreaTriggerScripts();

    sLog->outString("Загрузка Graveyard-zone links...");
    sObjectMgr->LoadGraveyardZones();

    sLog->outString("Загрузка spell pet auras...");
    sSpellMgr->LoadSpellPetAuras();

    sLog->outString("Загрузка Spell target coordinates...");
    sSpellMgr->LoadSpellTargetPositions();

    sLog->outString("Загрузка enchant custom attributes...");
    sSpellMgr->LoadEnchantCustomAttr();

    sLog->outString("Загрузка linked spells...");
    sSpellMgr->LoadSpellLinked();

    sLog->outString("Загрузка Player Create Data...");
    sObjectMgr->LoadPlayerInfo();

    sLog->outString("Загрузка Exploration BaseXP Data...");
    sObjectMgr->LoadExplorationBaseXP();

    sLog->outString("Загрузка Pet Name Parts...");
    sObjectMgr->LoadPetNames();

    CharacterDatabaseCleaner::CleanDatabase();

    sLog->outString("Загрузка the max pet number...");
    sObjectMgr->LoadPetNumber();

    sLog->outString("Загрузка pet level stats...");
    sObjectMgr->LoadPetLevelInfo();

    sLog->outString("Загрузка Player Corpses...");
    sObjectMgr->LoadCorpses();

    sLog->outString("Загрузка Player level dependent mail rewards...");
    sObjectMgr->LoadMailLevelRewards();

    // Loot tables
    LoadLootTables();

    sLog->outString("Загрузка Skill Discovery Table...");
    LoadSkillDiscoveryTable();

    sLog->outString("Загрузка Skill Extra Item Table...");
    LoadSkillExtraItemTable();

    sLog->outString("Загрузка Skill Fishing base level requirements...");
    sObjectMgr->LoadFishingBaseSkillLevel();

    sLog->outString("Загрузка Достижений...");
    sAchievementMgr->LoadAchievementReferenceList();
    sLog->outString("Загрузка Achievement Criteria Lists...");
    sAchievementMgr->LoadAchievementCriteriaList();
    sLog->outString("Загрузка Achievement Criteria Data...");
    sAchievementMgr->LoadAchievementCriteriaData();
    sLog->outString("Загрузка Achievement Rewards...");
    sAchievementMgr->LoadRewards();
    sLog->outString("Загрузка Achievement Reward Locales...");
    sAchievementMgr->LoadRewardLocales();
    sLog->outString("Загрузка Completed Achievements...");
    sAchievementMgr->LoadCompletedAchievements();

    // Delete expired auctions before Загрузка
    sLog->outString("Deleting expired auctions...");
    sAuctionMgr->DeleteExpiredAuctionsAtStartup();

    ///- Load dynamic data tables from the database
    sLog->outString("Загрузка Item Auctions...");
    sAuctionMgr->LoadAuctionItems();
    sLog->outString("Загрузка Auctions...");
    sAuctionMgr->LoadAuctions();

    sGuildMgr->LoadGuilds();

    sLog->outString("Загрузка ArenaTeams...");
    sArenaTeamMgr->LoadArenaTeams();

    sLog->outString("Загрузка Groups...");
    sGroupMgr->LoadGroups();

    sLog->outString("Загрузка ReservedNames...");
    sObjectMgr->LoadReservedPlayersNames();

    sLog->outString("Загрузка GameObjects for quests...");
    sObjectMgr->LoadGameObjectForQuests();

    sLog->outString("Загрузка BattleMasters...");
    sBattlegroundMgr->LoadBattleMastersEntry();

    sLog->outString("Загрузка GameTeleports...");
    sObjectMgr->LoadGameTele();

    sLog->outString("Загрузка Gossip menu...");
    sObjectMgr->LoadGossipMenu();

    sLog->outString("Загрузка Gossip menu options...");
    sObjectMgr->LoadGossipMenuItems();

    sLog->outString("Загрузка Vendors...");
    sObjectMgr->LoadVendors();                                   // must be after load CreatureTemplate and ItemTemplate

    sLog->outString("Загрузка Trainers...");
    sObjectMgr->LoadTrainerSpell();                              // must be after load CreatureTemplate

    sLog->outString("Загрузка Waypoints...");
    sWaypointMgr->Load();

    sLog->outString("Загрузка SmartAI Waypoints...");
    sSmartWaypointMgr->LoadFromDB();

    sLog->outString("Загрузка Creature Formations...");
    sFormationMgr->LoadCreatureFormations();

    sLog->outString("Загрузка World States...");              // must be loaded before battleground, outdoor PvP and conditions
    LoadWorldStates();

    sLog->outString("Загрузка запретов...");
    sConditionMgr->LoadConditions();

    sLog->outString("Загрузка faction change achievement pairs...");
    sObjectMgr->LoadFactionChangeAchievements();

    sLog->outString("Загрузка faction change spell pairs...");
    sObjectMgr->LoadFactionChangeSpells();

    sLog->outString("Загрузка faction change item pairs...");
    sObjectMgr->LoadFactionChangeItems();

    sLog->outString("Загрузка faction change reputation pairs...");
    sObjectMgr->LoadFactionChangeReputations();

    sLog->outString("Загрузка GM tickets...");
    sTicketMgr->LoadTickets();

    sLog->outString("Загрузка GM surveys...");
    sTicketMgr->LoadSurveys();

    sLog->outString("Загрузка client addons...");
    AddonMgr::LoadFromDB();
    ...
    sLog->outString("Загрузка автообъявлений...");
    LoadAutobroadcasts();
    ...
    sLog->outString("Загрузка Scripts text locales...");      // must be after Load*Scripts calls
    sObjectMgr->LoadDbScriptStrings();

    sLog->outString("Загрузка CreatureEventAI Texts...");
    sEventAIMgr->LoadCreatureEventAI_Texts();

    sLog->outString("Загрузка CreatureEventAI Summons...");
    sEventAIMgr->LoadCreatureEventAI_Summons();

    sLog->outString("Загрузка CreatureEventAI Scripts...");
    sEventAIMgr->LoadCreatureEventAI_Scripts();

    sLog->outString("Загрузка spell script names...");
    sObjectMgr->LoadSpellScriptNames();

    sLog->outString("Загрузка Creature Texts...");
    sCreatureTextMgr->LoadCreatureTexts();

    sLog->outString("Загрузка Creature Text Locales...");
    ...
    sLog->outString("Загрузка SmartAI scripts...");
    sSmartScriptMgr->LoadSmartAIFromDB();

    sLog->outString("Загрузка Calendar data...");
    sCalendarMgr->LoadFromDB();

    ///- Initialize game time and timers
    sLog->outString("Загрузка игрового времени");
    m_gameTime = time(NULL);
    m_startTime = m_gameTime;
    ...
    sLog->outString("Запуск систем карт");
    sMapMgr->Initialize();

    sLog->outString("Запуск игровых событый...");
    ...
    sLog->outString("Запуск Сезона Арены...");
    sGameEventMgr->StartArenaSeason();

    sTicketMgr->Initialize();

    ///- Initialize Battlegrounds
    sLog->outString("Запуск системы поле боя");
    sBattlegroundMgr->CreateInitialBattlegrounds();
    sBattlegroundMgr->InitAutomaticArenaPointDistribution();

    ///- Initialize outdoor pvp
    sLog->outString("Запуск системы ОЛО");
    sOutdoorPvPMgr->InitOutdoorPvP();

    sLog->outString("Загрузка Транспорта...");
    sMapMgr->LoadTransports();

    sLog->outString("Загрузка Транспорта NPCs...");
    sMapMgr->LoadTransportNPCs();

    ///- Initialize Warden
    sLog->outString("Загрузка Warden Checks..." );
    sWardenCheckMgr->LoadWardenChecks();

    sLog->outString("Загрузка Warden Action Overrides..." );
    sWardenCheckMgr->LoadWardenOverrides();

    sLog->outString("Удаление expired bans...");
    LoginDatabase.Execute("DELETE FROM ip_banned WHERE unbandate <= UNIX_TIMESTAMP() AND unbandate<>bandate");      // One-time query

    sLog->outString("Расчёт времени до сброса дейли кв...");
    InitDailyQuestResetTime();

    sLog->outString("Расчёт времени до сброса еженедельных кв..." );
    InitWeeklyQuestResetTime();

    sLog->outString("Расчёт времени до сброса бг..." );
    InitRandomBGResetTime();

    LoadCharacterNameData();

    sLog->outString("Инициализация AuctionHouseBot...");
    ...
    sLog->outString();
    sLog->outString("МИР: Мир загрузился за %u минут %u секунд", (startupDuration / 60000), ((startupDuration % 60000) / 1000));
    sLog->outString();
}
...
void World::LoadAutobroadcasts()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 autobroadcasts definitions. DB table `autobroadcast` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u autobroadcasts definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void World::Update(uint32 diff)
{
    ...
    if (m_timers[WUPDATE_UPTIME].Passed())
    {
        ...
        QueryResult result = LoginDatabase.Query("SELECT maxplayers FROM uptime");
        Field* fields = result->Fetch();
...
/// Send a packet to all players (or players selected team) in the guild (except self if mentioned)
void World::SendGuildMessage(uint32 guild, WorldPacket* packet, WorldSession* self, uint32 team)
{
    SessionMap::const_iterator itr;
    for (itr = m_sessions.begin(); itr != m_sessions.end(); ++itr)
    {
...
/// Send a System Message to all players in the guild (except self if mentioned)
...
void World::ShutdownMsg(bool show, Player* player)
{
    ...
    if (show ||
		...
		(m_ShutdownTimer < 1 * MINUTE && (m_ShutdownTimer % 10) == 0) || // < 1 min; every 10 sec
		(m_ShutdownTimer < 5 * MINUTE && (m_ShutdownTimer % 30) == 0) || // < 5 min; every 30 sec
...
void World::SendAutoBroadcast()
{
    ...
    sLog->outDetail("Автосообщение: '%s'", msg.c_str());
}
...
{
    sLog->outDetail("Сброс дейли(ежедневных) квестов для всех персонажей.");
...
{
    sLog->outDetail("Случайное поле боя сброшено для всех персонажей.");
...
void World::LoadDBVersion()
{
    ...
    if (m_DBVersion.empty())
        m_DBVersion = "Неизвестная база данных.";
}
...
void World::LoadWorldStates()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 world states. DB table `worldstates` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u world states in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void World::LoadCharacterNameData()
{
    ...
    sLog->outString("Загружено %u персонажей", count);
}
