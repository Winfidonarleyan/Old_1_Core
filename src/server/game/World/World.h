...
enum WorldBoolConfigs
{
    ...
    CONFIG_ARENA_SPECTATORS_ONLY_FRIEND,
    CONFIG_BOSS_KILL_HISTORY_REWARD_ENABLE,
    CONFIG_BOSS_KILL_HISTORY_ENABLE,
    CONFIG_MULTIBOXING_KICK_ENABLE,
    CONFIG_MULTIBOXING_KICK_ONLY_ON_BG_OR_ARENA,
    CONFIG_GM_CHAT_BLUE,
	CONFIG_UNELL_GM_HELLO,
	CONFIG_UNELL_PLAYER_HELLO,
	CONFIG_UNELL_GM_ENTER,
	CONFIG_UNELL_BOSS_ANNOUNCER,
	CONFIG_UNELL_GM_ENTER_LEVEL_1,
	CONFIG_UNELL_GM_ENTER_LEVEL_2,
	CONFIG_UNELL_GM_ENTER_LEVEL_3,
	CONFIG_UNELL_GM_ENTER_LEVEL_4,
	CONFIG_UNELL_GM_ENTER_LEVEL_5,
	CONFIG_UNELL_GM_ENTER_LEVEL_6,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CHAT_CHANNEL_TIME_REQ,
    CONFIG_CHAT_WHISPER_TIME_REQ,
    CONFIG_CHAT_SAY_TIME_REQ,
    ...
    CONFIG_TRIUMPH_FOR_FROST_COUNT,
    ...
    TRANSMOGRIFICATION_REQUIRED_MONEY,
	...
	CONFIG_END_ARENA_ADD_WIN,
	CONFIG_END_ARENA_ADD_LOST,
	CONFIG_END_ARENA_ADD_ITEM,
	CONFIG_END_ARENA_ADD_ITEM_COUNT,
	CONFIG_GM_CHAT_COLOR,
	CONFIG_UNELL_PLAYED_INTERVAL,
	CONFIG_UNELL_PLAYED_MONEY,
	CONFIG_UNELL_PLAYED_HONOR,
	CONFIG_UNELL_PLAYED_TOKEN,
	CONFIG_UNELL_PLAYED_TOKENID,
...
enum Rates
{
    ...
    RATE_MOVESPEED,
	RATE_CAP_RESILIENCE_MELEE,
    RATE_CAP_RESILIENCE_RANGED,
    RATE_CAP_RESILIENCE_SPELL,
    RATE_CAP_DODGE_FROM_AGILITY,
    RATE_CAP_MANA_REGEN,
    RATE_REDUCTION_MELEE_DAMAGE,
    MAX_RATES
};
...
class World
{
    public:
		...
		std::string GetDatadbcPath() const { return m_datadbcPath; }
		...
		void SendGuildMessage(uint32 guild, WorldPacket* packet, WorldSession* self = 0, uint32 team = 0);
        void SendGuildText(uint32 guild, const char *text, WorldSession* self = 0, uint32 team = 0);
