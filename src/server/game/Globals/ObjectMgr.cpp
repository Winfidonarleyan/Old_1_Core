...
void ObjectMgr::LoadCreatureLocales()
{
    ...
    sLog->outString(">> Загружено %lu creature locale strings in %u ms", (unsigned long)_creatureLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGossipMenuItemsLocales()
{
    ...
    sLog->outString(">> Загружено %lu gossip_menu_option locale strings in %u ms", (unsigned long)_gossipMenuItemsLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPointOfInterestLocales()
{
    ...
    sLog->outString(">> Загружено %lu points_of_interest locale strings in %u ms", (unsigned long)_pointOfInterestLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureTemplates()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature template definitions. DB table `creature_template` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureTemplateAddons()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature template addon definitions. DB table `creature_template_addon` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature template addons in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureAddons()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature addon definitions. DB table `creature_addon` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature addons in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadEquipmentTemplates()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature equipment templates. DB table `creature_equip_template` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u equipment templates in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureModelInfo()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature model definitions. DB table `creature_model_info` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature model based info in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadLinkedRespawn()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 linked respawns. DB table `linked_respawn` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено " UI64FMTD " linked respawns in %u ms", uint64(_linkedRespawnStore.size()), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatures()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 creatures. DB table `creature` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creatures in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameobjects()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 gameobjects. DB table `gameobject` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %lu gameobjects in %u ms", (unsigned long)_gameObjectDataStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureRespawnTimes()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature respawn time.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %lu creature respawn times in %u ms", (unsigned long)_creatureRespawnTimes.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameobjectRespawnTimes()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 gameobject respawn times. DB table `gameobject_respawn` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString();
    sLog->outString(">> Загружено %lu gameobject respawn times in %u ms", (unsigned long)_goRespawnTimes.size(), GetMSTimeDiffToNow(oldMSTime));
}
...
void ObjectMgr::LoadItemLocales()
{
    ...
    sLog->outString(">> Загружено %lu Item locale strings in %u ms", (unsigned long)_itemLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadItemTemplates()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 item templates. DB table `item_template` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u item templates in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadItemSetNameLocales()
{
    ...
    sLog->outString(">> Загружено " UI64FMTD " Item set name locale strings in %u ms", uint64(_itemSetNameLocaleStore.size()), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadItemSetNames()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 item set names. DB table `item_set_names` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u item set names in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadFakeItems()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 fake items. DB table `fake_items` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u fake items.", _fakeItemsStore.size());
    sLog->outString();
}
...
void ObjectMgr::LoadVehicleTemplateAccessories()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 vehicle template accessories. DB table `vehicle_template_accessory` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u Vehicle Template Accessories in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadVehicleAccessories()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 Vehicle Accessories in %u ms", GetMSTimeDiffToNow(oldMSTime));
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u Vehicle Accessories in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPetLevelInfo()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 level pet stats definitions. DB table `pet_levelstats` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u level pet stats definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPlayerInfo()
{
    // Load playercreate
    {
        ...
        {
            sLog->outString();
            sLog->outErrorDb(">> Загружено 0 player create definitions. DB table `playercreateinfo` is empty.");
            exit(1);
        }
        else
        {
            ...
            sLog->outString(">> Загружено %u player create definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
            sLog->outString();
        }
    }
    ...
    sLog->outString("Loading Player Create Items Data...");
    {
        ...
        if (!result)
        {
            sLog->outString(">> Загружено 0 custom player create items. DB table `playercreateinfo_item` is empty.");
            sLog->outString();
        }
        else
        {
            ...
            sLog->outString(">> Загружено %u custom player create items in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
            sLog->outString();
        }
    }
    ...
    sLog->outString("Loading Player Create Spell Data...");
    {
        ...
        if (!result)
        {
            sLog->outErrorDb(">> Загружено 0 player create spells. DB table `%s` is empty.", sWorld->getBoolConfig(CONFIG_START_ALL_SPELLS) ? "playercreateinfo_spell_custom" : "playercreateinfo_spell");
            sLog->outString();
        }
        else
        {
            ...
            sLog->outString(">> Загружено %u player create spells in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
            sLog->outString();
        }
    }
    ...
    sLog->outString("Loading Player Create Action Data...");
    {
        ...
        if (!result)
        {
            sLog->outErrorDb(">> Загружено 0 player create actions. DB table `playercreateinfo_action` is empty.");
            sLog->outString();
        }
        else
        {
            ...
            sLog->outString(">> Загружено %u player create actions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
            sLog->outString();
        }
    }
    ...
    sLog->outString("Loading Player Create Level HP/Mana Data...");
    {
        ...
        if (!result)
        {
            sLog->outErrorDb(">> Загружено 0 level health/mana definitions. DB table `game_event_condition` is empty.");
            sLog->outString();
            exit(1);
        }
        ...
        sLog->outString(">> Загружено %u level health/mana definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
        sLog->outString();
    }
    ...
    sLog->outString("Loading Player Create Level Stats Data...");
    {
        ...
        if (!result)
        {
            sLog->outErrorDb(">> Загружено 0 level stats definitions. DB table `player_levelstats` is empty.");
            sLog->outString();
            exit(1);
        }
        ...
        sLog->outString(">> Загружено %u level stats definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
        sLog->outString();
    }
    ...
    sLog->outString("Loading Player Create XP Data...");
    {
        ...
        if (!result)
        {
            sLog->outErrorDb(">> Загружено 0 xp for level definitions. DB table `player_xp_for_level` is empty.");
            sLog->outString();
            exit(1);
        }
        ...
        sLog->outString(">> Загружено %u xp for level definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
        sLog->outString();
    }
}
...
void ObjectMgr::LoadQuests()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 quests definitions. DB table `quest_template` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %lu quests definitions in %u ms", (unsigned long)_questTemplates.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadQuestLocales()
{
    ...
    sLog->outString(">> Загружено %lu Quest locale strings in %u ms", (unsigned long)_questLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadScripts(ScriptsType type)
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 script definitions. DB table `%s` is empty!", tableName.c_str());
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u script definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadSpellScriptNames()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 spell script names. DB table `spell_script_names` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u spell script names in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPageTexts()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 page texts. DB table `page_text` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u page texts in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPageTextLocales()
{
    ...
    sLog->outString(">> Загружено %lu PageText locale strings in %u ms", (unsigned long)_pageTextLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadInstanceTemplate()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 instance templates. DB table `page_text` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u instance templates in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadInstanceEncounters()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 instance encounters, table is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u instance encounters in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGossipText()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено %u npc texts", count);
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u npc texts in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadNpcTextLocales()
{
    ...
    sLog->outString(">> Загружено %lu NpcText locale strings in %u ms", (unsigned long)_npcTextLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadQuestAreaTriggers()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 quest trigger points. DB table `areatrigger_involvedrelation` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u quest trigger points in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadTavernAreaTriggers()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 tavern triggers. DB table `areatrigger_tavern` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u tavern triggers in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadAreaTriggerScripts()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 areatrigger scripts. DB table `areatrigger_scripts` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u areatrigger scripts in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGraveyardZones()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 graveyard-zone links. DB table `game_graveyard_zone` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u graveyard-zone links in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadAreaTriggerTeleports()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 area trigger teleport definitions. DB table `areatrigger_teleport` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u area trigger teleport definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadAccessRequirements()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 access requirement definitions. DB table `access_requirement` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u access requirement definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameObjectLocales()
{
    ...
    sLog->outString(">> Загружено %lu gameobject locale strings in %u ms", (unsigned long)_gameObjectLocaleStore.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameObjectTemplate()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 gameobject definitions. DB table `gameobject_template` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u game object templates in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadExplorationBaseXP()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 BaseXP definitions. DB table `exploration_basexp` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u BaseXP definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPetNames()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 pet name parts. DB table `pet_name_generation` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u pet name parts in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPetNumber()
{
    ...
    sLog->outString(">> Загружено the max pet number: %d in %u ms", _hiPetNumber-1, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCorpses()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 corpses. DB table `corpse` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u corpses in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadReputationRewardRate()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено `reputation_reward_rate`, table is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u reputation_reward_rate in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadReputationOnKill()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 creature award reputation definitions. DB table `creature_onkill_reputation` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature award reputation definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadReputationSpilloverTemplate()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено `reputation_spillover_template`, table is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u reputation_spillover_template in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadPointsOfInterest()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 Points of Interest definitions. DB table `points_of_interest` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u Points of Interest definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadQuestPOI()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 quest POI definitions. DB table `quest_poi` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u quest POI definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadNPCSpellClickSpells()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 spellclick spells. DB table `npc_spellclick_spells` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u spellclick definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadQuestRelationsHelper(QuestRelations& map, std::string table, bool starter, bool go)
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 quest relations from `%s`, table is empty.", table.c_str());
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u quest relations from %s in %u ms", count, table.c_str(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}

void ObjectMgr::LoadGameobjectQuestRelations()
{
    LoadQuestRelationsHelper(_goQuestRelations, "gameobject_questender", true, true);
...
{
    LoadQuestRelationsHelper(_goQuestInvolvedRelations, "gameobject_queststarter", false, true);
...
{
    LoadQuestRelationsHelper(_creatureQuestRelations, "creature_questender", true, false);
...
{
    LoadQuestRelationsHelper(_creatureQuestInvolvedRelations, "creature_queststarter", false, false);
...
void ObjectMgr::LoadReservedPlayersNames()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 reserved player names. DB table `reserved_name` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u reserved player names in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameObjectForQuests()
{
    ...
    {
        sLog->outString(">> Загружено 0 GameObjects for quests");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u GameObjects for quests in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
bool ObjectMgr::LoadTrinityStrings(const char* table, int32 min_value, int32 max_value)
{
    ...
    if (!result)
    {
        if (min_value == MIN_TRINITY_STRING_ID)              // error only in case internal strings
            sLog->outErrorDb(">> Загружено 0 trinity strings. DB table `%s` is empty. Cannot continue.", table);
        else
            sLog->outString(">> Загружено 0 string templates. DB table `%s` is empty.", table);
        sLog->outString();
        return false;
    }
    ...
    if (min_value == MIN_TRINITY_STRING_ID)
        sLog->outString(">> Загружено %u Trinity strings from table %s in %u ms", count, table, GetMSTimeDiffToNow(oldMSTime));
    else
        sLog->outString(">> Загружено %u string templates from %s in %u ms", count, table, GetMSTimeDiffToNow(oldMSTime));
...
void ObjectMgr::LoadFishingBaseSkillLevel()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 areas for fishing base skill level. DB table `skill_fishing_base_level` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u areas for fishing base skill level in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGameTele()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 GameTeleports. DB table `game_tele` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u GameTeleports in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadMailLevelRewards()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 level dependent mail rewards. DB table `mail_level_reward` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u level dependent mail rewards in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadTrainerSpell()
{
    ...
    sLog->outString(">> Загружено %d Trainers in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadVendors()
{
    ...
    sLog->outString(">> Загружено %d Vendors in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGossipMenu()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0  gossip_menu entries. DB table `gossip_menu` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u gossip_menu entries in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadGossipMenuItems()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 gossip_menu_option entries. DB table `gossip_menu_option` is empty!");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u gossip_menu_option entries in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadScriptNames()
{
    ...
    {
        sLog->outString();
        sLog->outErrorDb(">> Загружено empty set of Script Names!");
        return;
    }
    ...
    sLog->outString(">> Загружено %d Script Names in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadCreatureClassLevelStats()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 creature base stats. DB table `creature_classlevelstats` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u creature base stats in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadFactionChangeAchievements()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 faction change achievement pairs. DB table `player_factionchange_achievement` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u faction change achievement pairs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadFactionChangeItems()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 faction change item pairs. DB table `player_factionchange_items` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u faction change item pairs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadFactionChangeSpells()
{
    ...
    if (!result)
    {
        sLog->outErrorDb(">> Загружено 0 faction change spell pairs. DB table `player_factionchange_spells` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u faction change spell pairs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
...
void ObjectMgr::LoadFactionChangeReputations()
{
    ...
    if (!result)
    {
        sLog->outString(">> Загружено 0 faction change reputation pairs. DB table `player_factionchange_reputations` is empty.");
        sLog->outString();
        return;
    }
    ...
    sLog->outString(">> Загружено %u faction change reputation pairs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
