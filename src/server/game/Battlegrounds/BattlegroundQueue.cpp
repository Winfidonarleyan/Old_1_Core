         	...
         	if (sWorld->getBoolConfig(BATTLEGROUND_CROSSFACTION_ENABLED))
                {
                    ...
                    else
                    {
                        ...
                        // ss << "|cffff0000[БГ Анонс]:|r |cff14ECCF" << bgName << "|r|cff6C8CD5 -- |cff14ECCF" << qPlayers << "|cff6C8CD5/|cff14ECCF" << MinPlayers;
                        // sWorld->SendGlobalText(ss.str().c_str(), NULL);
						// bgName, qPlayers, MinPlayers
						sWorld->SendWorldText(LANG_BG_QUEUE_ANNOUNCE_WORLD, bgName, qPlayers, MinPlayers);
                    }
                }
                // System message
                else
