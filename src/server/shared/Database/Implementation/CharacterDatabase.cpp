...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(CHAR_INS_BOSS_KILL_HISTORY, "INSERT INTO `character_boss_kill_history` (`GuildId`, `CreatureEntry`, `KillerCount`, `KillData`, `MapId`, `MapRaid`, `CreatureName`, `MapName`, `MapSpawnMode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
}
